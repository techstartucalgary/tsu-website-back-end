...
urlpatterns = [
    ...
    path('post/create', views.createUserPost.as_view(), name='Create User Post'),
    path('post/update/<int:pk>', views.updateUserPost.as_view(), name='Update User Post'),
    path('post/<int:pk>/delete', views.deleteUserPost.as_view(), name='Delete User Post'),
